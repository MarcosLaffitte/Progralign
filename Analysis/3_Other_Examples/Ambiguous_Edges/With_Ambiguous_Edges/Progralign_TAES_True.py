...
print(constructionDict["SimilarityMatrix"])
...
if(vis2D):
    ...
    for eachLeaf in allLeaves:
        ...
        nx.draw_networkx(finalAlignment, with_labels = False, pos = posAlignment, node_size = 25,
                         node_color = "darkgray", edge_color = "darkgray", width = 0.25)
        # plot input graph
        nx.draw_networkx(graphLeaf, with_labels = True, labels = mapToRoot[eachLeaf],
                         pos = posLeaf, node_size = 400, nodelist = nodeList, node_color = nodeColor,
    ...
    nx.draw_networkx(finalAlignment, with_labels = True,
                     pos = posAlignment, node_size = 300, node_color = "silver",
                     font_size = 8, edge_color = "k", width = 3)

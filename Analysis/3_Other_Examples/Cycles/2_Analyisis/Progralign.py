...
if(vis2D):
    ...
    for eachLeaf in allLeaves:
        ...
        nx.draw_networkx(finalAlignment, with_labels = False, pos = posAlignment, node_size = 80,
                         node_color = "lightgray", edge_color = "lightgray", width = 1)
        # plot input graph
        nx.draw_networkx(graphLeaf, with_labels = True, labels = mapToRoot[eachLeaf],
                         pos = posLeaf, node_size = 280, nodelist = nodeList, node_color = nodeColor,
                         font_size = 8, edge_color = "k", width = 3)
    ...
    nx.draw_networkx(finalAlignment, with_labels = True,
                     pos = posAlignment, node_size = 280, node_color = "silver",
                     font_size = 8, edge_color = "k", width = 3)
...
if(vis1D):
    ...
    nx.draw_networkx(finalAlignment, with_labels = True,
                     pos = posAlignment, node_size = 220,
                     font_size = 6, node_color = "silver",
                     edge_color = "k", width = 3)
    ...
    ax.set_xticklabels(nodesAlignment, fontsize = 6)
    ax.set_yticklabels(allLeaves, fontsize = 6)
    # set minor ticks
    ...
    # finish image
    plt.title("Matrix Representation of the Alignment\n", fontsize = 8, weight = "light")
    plt.xlabel("\nVertices of the alignment", fontsize = 6.5, weight = "light")
    plt.ylabel("Input Graphs\n", fontsize = 6.5, weight = "light")
    # save page
    sanityCheckPDF.savefig(fig)
    # clear current figure
    plt.clf()

...
# expand-experiments
constructionDict = dict()                    # expand with ambiguous edges
constructionDict_notAE = dict()              # expand without ambiguous edges
constructionDict_rGT1 = dict()               # expand over random guide tree 1 with ambiguous edges
constructionDict_rGT1_notAE = dict()         # expand over random guide tree 1 without ambiguous edges
constructionDict_rGT2 = dict()               # expand over random guide tree 2 with ambiguous edges
constructionDict_rGT2_notAE = dict()         # expand over random guide tree 2 without ambiguous edges
constructionDict_rGT3 = dict()               # expand over random guide tree 3 with ambiguous edges
constructionDict_rGT3_notAE = dict()         # expand over random guide tree 3 without ambiguous edges
# trimm-experiments
constructionDict_trimm = dict()              # trimm with ambiguous edges
constructionDict_trimm_notAE = dict()        # trimm without ambiguous edges
constructionDict_trimm_rGT1 = dict()         # trimm over random guide tree 1 with ambiguous edges
constructionDict_trimm_rGT1_notAE = dict()   # trimm over random guide tree 1 without ambiguous edges
constructionDict_trimm_rGT2 = dict()         # trimm over random guide tree 2 with ambiguous edges
constructionDict_trimm_rGT2_notAE = dict()   # trimm over random guide tree 2 without ambiguous edges
constructionDict_trimm_rGT3 = dict()         # trimm over random guide tree 3 with ambiguous edges
constructionDict_trimm_rGT3_notAE = dict()   # trimm over random guide tree 3 without ambiguous edges
...
# task message
print("* initializing dictionary for experiment with random tree ...")


# initialize dictionary for experiment with random trees
constructionDict_rGT1 = deepcopy(constructionDict)
constructionDict_rGT2 = deepcopy(constructionDict)
constructionDict_rGT3 = deepcopy(constructionDict)
...
# task message
print("* initializing dictionaries for experiments with and without ambiguous edges ...")


# initialize dictinoaries for experiments with random trees
# expand-experiments
constructionDict_notAE = deepcopy(constructionDict)
# trimm-experiments
constructionDict_trimm = deepcopy(constructionDict)
constructionDict_trimm_notAE = deepcopy(constructionDict)


# task message
print("* Building random guide trees for experiments ...")


# build clustering graph
maxDist = len(list(combinations(indices, r = 2)))
randomDists = list(range(1, maxDist+1))
randomClusteringGraphs = []
totRandExp = 3
for experiment in range(1, totRandExp+1):
    # initialize clustering graph
    clusteringGraph = nx.Graph()
    # create array of random distances
    random.shuffle(randomDists)
    countDist = 0
    # add edges to clustering graph
    for (i, j) in list(combinations(indices, r = 2)):
        # build similarity graph based on random ordering
        clusteringGraph.add_edge(str(i), str(j), measure = randomDists[countDist])
        countDist = countDist + 1
    # save random clustering graph
    randomClusteringGraphs.append(deepcopy(clusteringGraph))


# construction of random guide trees
# GT1
randDendrogram, randGuideTree, randContainedGraphs = getGuideTree(randomClusteringGraphs[0], guideTreeMeasure)
constructionDict_rGT1["GTMeasure"] = guideTreeMeasure
constructionDict_rGT1["Dendrogram"] = randDendrogram
constructionDict_rGT1["GuideTree"] = deepcopy(randGuideTree)
constructionDict_rGT1["Contained"] = deepcopy(randContainedGraphs)
# GT2
randDendrogram, randGuideTree, randContainedGraphs = getGuideTree(randomClusteringGraphs[1], guideTreeMeasure)
constructionDict_rGT2["GTMeasure"] = guideTreeMeasure
constructionDict_rGT2["Dendrogram"] = randDendrogram
constructionDict_rGT2["GuideTree"] = deepcopy(randGuideTree)
constructionDict_rGT2["Contained"] = deepcopy(randContainedGraphs)
# GT3
randDendrogram, randGuideTree, randContainedGraphs = getGuideTree(randomClusteringGraphs[2], guideTreeMeasure)
constructionDict_rGT3["GTMeasure"] = guideTreeMeasure
constructionDict_rGT3["Dendrogram"] = randDendrogram
constructionDict_rGT3["GuideTree"] = deepcopy(randGuideTree)
constructionDict_rGT3["Contained"] = deepcopy(randContainedGraphs)


# construction of random guide trees dictionaries
constructionDict_rGT1_notAE = deepcopy(constructionDict_rGT1)
constructionDict_trimm_rGT1 = deepcopy(constructionDict_rGT1)
constructionDict_trimm_rGT1_notAE = deepcopy(constructionDict_rGT1)
constructionDict_rGT2_notAE = deepcopy(constructionDict_rGT2)
constructionDict_trimm_rGT2 = deepcopy(constructionDict_rGT2)
constructionDict_trimm_rGT2_notAE = deepcopy(constructionDict_rGT2)
constructionDict_rGT3_notAE = deepcopy(constructionDict_rGT3)
constructionDict_trimm_rGT3 = deepcopy(constructionDict_rGT3)
constructionDict_trimm_rGT3_notAE = deepcopy(constructionDict_rGT3)


# task message
print("\n")
print("* Progressive graph alignment - Expand - With Ambiguous Edges")
...
# task message
print("\n")
print("* Progressive graph alignment - Expand - Without Ambiguous Edges")
# progressive graph alignment
alignmentResults = PGA(theType, guideTreeSSP, constructionDict, dendrogramSSP,
                       containedGraphsSSP, requestedScore,
                       holdV = respectVLabels, holdE = respectELabels,
                       ...
                       algorithm = MCSalgorithm)
# unpack results
constructionDict_notAE["Alignment"] = deepcopy(alignmentResults[0])
constructionDict_notAE["allAlignments"] = deepcopy(alignmentResults[1])
constructionDict_notAE["Existence"] = deepcopy(alignmentResults[2])
constructionDict_notAE["ScoreInfo"] = deepcopy(alignmentResults[3])
constructionDict_notAE["AmbiguousEdges"] = deepcopy(alignmentResults[4])
constructionDict_notAE["MapToRoot"] = deepcopy(alignmentResults[5])
constructionDict_notAE["AllLeaves"] = deepcopy(alignmentResults[6])
constructionDict_notAE["AllLeavesGraphs"] = deepcopy(alignmentResults[7])
constructionDict_notAE["Time"] = deepcopy(alignmentResults[8])


# task message
print("\n")
print("* Progressive graph alignment - Trimm - With Ambiguous Edges")
# progressive graph alignment
alignmentResults = PGA(theType, guideTreeSSP, constructionDict, dendrogramSSP,
                       containedGraphsSSP, requestedScore,
                       holdV = respectVLabels, holdE = respectELabels,
                       ...
                       algorithm = "trimm")
# unpack results
constructionDict_trimm["Alignment"] = deepcopy(alignmentResults[0])
constructionDict_trimm["allAlignments"] = deepcopy(alignmentResults[1])
constructionDict_trimm["Existence"] = deepcopy(alignmentResults[2])
constructionDict_trimm["ScoreInfo"] = deepcopy(alignmentResults[3])
constructionDict_trimm["AmbiguousEdges"] = deepcopy(alignmentResults[4])
constructionDict_trimm["MapToRoot"] = deepcopy(alignmentResults[5])
constructionDict_trimm["AllLeaves"] = deepcopy(alignmentResults[6])
constructionDict_trimm["AllLeavesGraphs"] = deepcopy(alignmentResults[7])
constructionDict_trimm["Time"] = deepcopy(alignmentResults[8])


# task message
print("\n")
print("* Progressive graph alignment - Trimm - Without Ambiguous Edges")
# progressive graph alignment
alignmentResults = PGA(theType, guideTreeSSP, constructionDict, dendrogramSSP,
                       containedGraphsSSP, requestedScore,
                       holdV = respectVLabels, holdE = respectELabels,
                       ...
                       algorithm = "trimm")
# unpack results
constructionDict_trimm_notAE["Alignment"] = deepcopy(alignmentResults[0])
constructionDict_trimm_notAE["allAlignments"] = deepcopy(alignmentResults[1])
constructionDict_trimm_notAE["Existence"] = deepcopy(alignmentResults[2])
constructionDict_trimm_notAE["ScoreInfo"] = deepcopy(alignmentResults[3])
constructionDict_trimm_notAE["AmbiguousEdges"] = deepcopy(alignmentResults[4])
constructionDict_trimm_notAE["MapToRoot"] = deepcopy(alignmentResults[5])
constructionDict_trimm_notAE["AllLeaves"] = deepcopy(alignmentResults[6])
constructionDict_trimm_notAE["AllLeavesGraphs"] = deepcopy(alignmentResults[7])
constructionDict_trimm_notAE["Time"] = deepcopy(alignmentResults[8])


# task message
print("\n")
print("* Progressive graph alignment - Random Tree 1 - expand - with ambiguous edges")
# progressive graph alignment
alignmentResults = PGA(theType, deepcopy(constructionDict_rGT1["GuideTree"]),
                       constructionDict_rGT1, constructionDict_rGT1["Dendrogram"],
                       constructionDict_rGT1["Contained"], requestedScore,
                       holdV = respectVLabels, holdE = respectELabels,
                       holdAmbEdges = ambiguousEdges,
                       algorithm = MCSalgorithm)
# unpack results
constructionDict_rGT1["Alignment"] = deepcopy(alignmentResults[0])
constructionDict_rGT1["allAlignments"] = deepcopy(alignmentResults[1])
constructionDict_rGT1["Existence"] = deepcopy(alignmentResults[2])
constructionDict_rGT1["ScoreInfo"] = deepcopy(alignmentResults[3])
constructionDict_rGT1["AmbiguousEdges"] = deepcopy(alignmentResults[4])
constructionDict_rGT1["MapToRoot"] = deepcopy(alignmentResults[5])
constructionDict_rGT1["AllLeaves"] = deepcopy(alignmentResults[6])
constructionDict_rGT1["AllLeavesGraphs"] = deepcopy(alignmentResults[7])
constructionDict_rGT1["Time"] = deepcopy(alignmentResults[8])


# task message
print("\n")
print("* Progressive graph alignment - Random Tree  1 - expand - without ambiguous edges")
# progressive graph alignment
alignmentResults = PGA(theType, deepcopy(constructionDict_rGT1["GuideTree"]),
                       constructionDict_rGT1, constructionDict_rGT1["Dendrogram"],
                       constructionDict_rGT1["Contained"], requestedScore,
                       ...
                       algorithm = MCSalgorithm)
# unpack results
constructionDict_rGT1_notAE["Alignment"] = deepcopy(alignmentResults[0])
constructionDict_rGT1_notAE["allAlignments"] = deepcopy(alignmentResults[1])
constructionDict_rGT1_notAE["Existence"] = deepcopy(alignmentResults[2])
constructionDict_rGT1_notAE["ScoreInfo"] = deepcopy(alignmentResults[3])
constructionDict_rGT1_notAE["AmbiguousEdges"] = deepcopy(alignmentResults[4])
constructionDict_rGT1_notAE["MapToRoot"] = deepcopy(alignmentResults[5])
constructionDict_rGT1_notAE["AllLeaves"] = deepcopy(alignmentResults[6])
constructionDict_rGT1_notAE["AllLeavesGraphs"] = deepcopy(alignmentResults[7])
constructionDict_rGT1_notAE["Time"] = deepcopy(alignmentResults[8])


# task message
print("\n")
print("* Progressive graph alignment - Random Tree 2 - expand - with ambiguous edges")
# progressive graph alignment
alignmentResults = PGA(theType, deepcopy(constructionDict_rGT2["GuideTree"]),
                       constructionDict_rGT2, constructionDict_rGT2["Dendrogram"],
                       constructionDict_rGT2["Contained"], requestedScore,
                       holdV = respectVLabels, holdE = respectELabels,
                       holdAmbEdges = ambiguousEdges,
                       algorithm = MCSalgorithm)
# unpack results
constructionDict_rGT2["Alignment"] = deepcopy(alignmentResults[0])
constructionDict_rGT2["allAlignments"] = deepcopy(alignmentResults[1])
constructionDict_rGT2["Existence"] = deepcopy(alignmentResults[2])
constructionDict_rGT2["ScoreInfo"] = deepcopy(alignmentResults[3])
constructionDict_rGT2["AmbiguousEdges"] = deepcopy(alignmentResults[4])
constructionDict_rGT2["MapToRoot"] = deepcopy(alignmentResults[5])
constructionDict_rGT2["AllLeaves"] = deepcopy(alignmentResults[6])
constructionDict_rGT2["AllLeavesGraphs"] = deepcopy(alignmentResults[7])
constructionDict_rGT2["Time"] = deepcopy(alignmentResults[8])


# task message
print("\n")
print("* Progressive graph alignment - Random Tree  2 - expand - without ambiguous edges")
# progressive graph alignment
alignmentResults = PGA(theType, deepcopy(constructionDict_rGT2["GuideTree"]),
                       constructionDict_rGT2, constructionDict_rGT2["Dendrogram"],
                       constructionDict_rGT2["Contained"], requestedScore,
                       ...
                       algorithm = MCSalgorithm)
# unpack results
constructionDict_rGT2_notAE["Alignment"] = deepcopy(alignmentResults[0])
constructionDict_rGT2_notAE["allAlignments"] = deepcopy(alignmentResults[1])
constructionDict_rGT2_notAE["Existence"] = deepcopy(alignmentResults[2])
constructionDict_rGT2_notAE["ScoreInfo"] = deepcopy(alignmentResults[3])
constructionDict_rGT2_notAE["AmbiguousEdges"] = deepcopy(alignmentResults[4])
constructionDict_rGT2_notAE["MapToRoot"] = deepcopy(alignmentResults[5])
constructionDict_rGT2_notAE["AllLeaves"] = deepcopy(alignmentResults[6])
constructionDict_rGT2_notAE["AllLeavesGraphs"] = deepcopy(alignmentResults[7])
constructionDict_rGT2_notAE["Time"] = deepcopy(alignmentResults[8])


# task message
print("\n")
print("* Progressive graph alignment - Random Tree 3 - expand - with ambiguous edges")
# progressive graph alignment
alignmentResults = PGA(theType, deepcopy(constructionDict_rGT3["GuideTree"]),
                       constructionDict_rGT3, constructionDict_rGT3["Dendrogram"],
                       constructionDict_rGT3["Contained"], requestedScore,
                       holdV = respectVLabels, holdE = respectELabels,
                       holdAmbEdges = ambiguousEdges,
                       algorithm = MCSalgorithm)
# unpack results
constructionDict_rGT3["Alignment"] = deepcopy(alignmentResults[0])
constructionDict_rGT3["allAlignments"] = deepcopy(alignmentResults[1])
constructionDict_rGT3["Existence"] = deepcopy(alignmentResults[2])
constructionDict_rGT3["ScoreInfo"] = deepcopy(alignmentResults[3])
constructionDict_rGT3["AmbiguousEdges"] = deepcopy(alignmentResults[4])
constructionDict_rGT3["MapToRoot"] = deepcopy(alignmentResults[5])
constructionDict_rGT3["AllLeaves"] = deepcopy(alignmentResults[6])
constructionDict_rGT3["AllLeavesGraphs"] = deepcopy(alignmentResults[7])
constructionDict_rGT3["Time"] = deepcopy(alignmentResults[8])


# task message
print("\n")
print("* Progressive graph alignment - Random Tree  3 - expand - without ambiguous edges")
# progressive graph alignment
alignmentResults = PGA(theType, deepcopy(constructionDict_rGT3["GuideTree"]),
                       constructionDict_rGT3, constructionDict_rGT3["Dendrogram"],
                       constructionDict_rGT3["Contained"], requestedScore,
                       ...
                       algorithm = MCSalgorithm)
# unpack results
constructionDict_rGT3_notAE["Alignment"] = deepcopy(alignmentResults[0])
constructionDict_rGT3_notAE["allAlignments"] = deepcopy(alignmentResults[1])
constructionDict_rGT3_notAE["Existence"] = deepcopy(alignmentResults[2])
constructionDict_rGT3_notAE["ScoreInfo"] = deepcopy(alignmentResults[3])
constructionDict_rGT3_notAE["AmbiguousEdges"] = deepcopy(alignmentResults[4])
constructionDict_rGT3_notAE["MapToRoot"] = deepcopy(alignmentResults[5])
constructionDict_rGT3_notAE["AllLeaves"] = deepcopy(alignmentResults[6])
constructionDict_rGT3_notAE["AllLeavesGraphs"] = deepcopy(alignmentResults[7])
constructionDict_rGT3_notAE["Time"] = deepcopy(alignmentResults[8])


# task message
print("\n")
print("* Progressive graph alignment - Random Tree 1 - trimm - with ambiguous edges")
# progressive graph alignment
alignmentResults = PGA(theType, deepcopy(constructionDict_rGT1["GuideTree"]),
                       constructionDict_rGT1, constructionDict_rGT1["Dendrogram"],
                       constructionDict_rGT1["Contained"], requestedScore,
                       ...
                       algorithm = "trimm")
# unpack results
constructionDict_trimm_rGT1["Alignment"] = deepcopy(alignmentResults[0])
constructionDict_trimm_rGT1["allAlignments"] = deepcopy(alignmentResults[1])
constructionDict_trimm_rGT1["Existence"] = deepcopy(alignmentResults[2])
constructionDict_trimm_rGT1["ScoreInfo"] = deepcopy(alignmentResults[3])
constructionDict_trimm_rGT1["AmbiguousEdges"] = deepcopy(alignmentResults[4])
constructionDict_trimm_rGT1["MapToRoot"] = deepcopy(alignmentResults[5])
constructionDict_trimm_rGT1["AllLeaves"] = deepcopy(alignmentResults[6])
constructionDict_trimm_rGT1["AllLeavesGraphs"] = deepcopy(alignmentResults[7])
constructionDict_trimm_rGT1["Time"] = deepcopy(alignmentResults[8])


# task message
print("\n")
print("* Progressive graph alignment - Random Tree  1 - trimm - without ambiguous edges")
# progressive graph alignment
alignmentResults = PGA(theType, deepcopy(constructionDict_rGT1["GuideTree"]),
                       constructionDict_rGT1, constructionDict_rGT1["Dendrogram"],
                       constructionDict_rGT1["Contained"], requestedScore,
                       ...
                       algorithm = "trimm")
# unpack results
constructionDict_trimm_rGT1_notAE["Alignment"] = deepcopy(alignmentResults[0])
constructionDict_trimm_rGT1_notAE["allAlignments"] = deepcopy(alignmentResults[1])
constructionDict_trimm_rGT1_notAE["Existence"] = deepcopy(alignmentResults[2])
constructionDict_trimm_rGT1_notAE["ScoreInfo"] = deepcopy(alignmentResults[3])
constructionDict_trimm_rGT1_notAE["AmbiguousEdges"] = deepcopy(alignmentResults[4])
constructionDict_trimm_rGT1_notAE["MapToRoot"] = deepcopy(alignmentResults[5])
constructionDict_trimm_rGT1_notAE["AllLeaves"] = deepcopy(alignmentResults[6])
constructionDict_trimm_rGT1_notAE["AllLeavesGraphs"] = deepcopy(alignmentResults[7])
constructionDict_trimm_rGT1_notAE["Time"] = deepcopy(alignmentResults[8])


# task message
print("\n")
print("* Progressive graph alignment - Random Tree 2 - trimm - with ambiguous edges")
# progressive graph alignment
alignmentResults = PGA(theType, deepcopy(constructionDict_rGT2["GuideTree"]),
                       constructionDict_rGT2, constructionDict_rGT2["Dendrogram"],
                       constructionDict_rGT2["Contained"], requestedScore,
                       ...
                       algorithm = "trimm")
# unpack results
constructionDict_trimm_rGT2["Alignment"] = deepcopy(alignmentResults[0])
constructionDict_trimm_rGT2["allAlignments"] = deepcopy(alignmentResults[1])
constructionDict_trimm_rGT2["Existence"] = deepcopy(alignmentResults[2])
constructionDict_trimm_rGT2["ScoreInfo"] = deepcopy(alignmentResults[3])
constructionDict_trimm_rGT2["AmbiguousEdges"] = deepcopy(alignmentResults[4])
constructionDict_trimm_rGT2["MapToRoot"] = deepcopy(alignmentResults[5])
constructionDict_trimm_rGT2["AllLeaves"] = deepcopy(alignmentResults[6])
constructionDict_trimm_rGT2["AllLeavesGraphs"] = deepcopy(alignmentResults[7])
constructionDict_trimm_rGT2["Time"] = deepcopy(alignmentResults[8])


# task message
print("\n")
print("* Progressive graph alignment - Random Tree  2 - trimm - without ambiguous edges")
# progressive graph alignment
alignmentResults = PGA(theType, deepcopy(constructionDict_rGT2["GuideTree"]),
                       constructionDict_rGT2, constructionDict_rGT2["Dendrogram"],
                       constructionDict_rGT2["Contained"], requestedScore,
                       ...
                       algorithm = "trimm")
# unpack results
constructionDict_trimm_rGT2_notAE["Alignment"] = deepcopy(alignmentResults[0])
constructionDict_trimm_rGT2_notAE["allAlignments"] = deepcopy(alignmentResults[1])
constructionDict_trimm_rGT2_notAE["Existence"] = deepcopy(alignmentResults[2])
constructionDict_trimm_rGT2_notAE["ScoreInfo"] = deepcopy(alignmentResults[3])
constructionDict_trimm_rGT2_notAE["AmbiguousEdges"] = deepcopy(alignmentResults[4])
constructionDict_trimm_rGT2_notAE["MapToRoot"] = deepcopy(alignmentResults[5])
constructionDict_trimm_rGT2_notAE["AllLeaves"] = deepcopy(alignmentResults[6])
constructionDict_trimm_rGT2_notAE["AllLeavesGraphs"] = deepcopy(alignmentResults[7])
constructionDict_trimm_rGT2_notAE["Time"] = deepcopy(alignmentResults[8])


# task message
print("\n")
print("* Progressive graph alignment - Random Tree 3 - trimm - with ambiguous edges")
# progressive graph alignment
alignmentResults = PGA(theType, deepcopy(constructionDict_rGT3["GuideTree"]),
                       constructionDict_rGT3, constructionDict_rGT3["Dendrogram"],
                       constructionDict_rGT3["Contained"], requestedScore,
                       ...
                       algorithm = "trimm")
# unpack results
constructionDict_trimm_rGT3["Alignment"] = deepcopy(alignmentResults[0])
constructionDict_trimm_rGT3["allAlignments"] = deepcopy(alignmentResults[1])
constructionDict_trimm_rGT3["Existence"] = deepcopy(alignmentResults[2])
constructionDict_trimm_rGT3["ScoreInfo"] = deepcopy(alignmentResults[3])
constructionDict_trimm_rGT3["AmbiguousEdges"] = deepcopy(alignmentResults[4])
constructionDict_trimm_rGT3["MapToRoot"] = deepcopy(alignmentResults[5])
constructionDict_trimm_rGT3["AllLeaves"] = deepcopy(alignmentResults[6])
constructionDict_trimm_rGT3["AllLeavesGraphs"] = deepcopy(alignmentResults[7])
constructionDict_trimm_rGT3["Time"] = deepcopy(alignmentResults[8])


# task message
print("\n")
print("* Progressive graph alignment - Random Tree  3 - trimm - without ambiguous edges")
# progressive graph alignment
alignmentResults = PGA(theType, deepcopy(constructionDict_rGT3["GuideTree"]),
                       constructionDict_rGT3, constructionDict_rGT3["Dendrogram"],
                       constructionDict_rGT3["Contained"], requestedScore,
                       ...
                       algorithm = "trimm")
# unpack results
constructionDict_trimm_rGT3_notAE["Alignment"] = deepcopy(alignmentResults[0])
constructionDict_trimm_rGT3_notAE["allAlignments"] = deepcopy(alignmentResults[1])
constructionDict_trimm_rGT3_notAE["Existence"] = deepcopy(alignmentResults[2])
constructionDict_trimm_rGT3_notAE["ScoreInfo"] = deepcopy(alignmentResults[3])
constructionDict_trimm_rGT3_notAE["AmbiguousEdges"] = deepcopy(alignmentResults[4])
constructionDict_trimm_rGT3_notAE["MapToRoot"] = deepcopy(alignmentResults[5])
constructionDict_trimm_rGT3_notAE["AllLeaves"] = deepcopy(alignmentResults[6])
constructionDict_trimm_rGT3_notAE["AllLeavesGraphs"] = deepcopy(alignmentResults[7])
constructionDict_trimm_rGT3_notAE["Time"] = deepcopy(alignmentResults[8])
...
# determine if self scoring
basicSelfScoring = (respectVLabels and respectELabels)
...
allExperiments = (constructionDict,
                  constructionDict_notAE,
                  constructionDict_rGT1,
                  constructionDict_rGT1_notAE,
                  constructionDict_rGT2,
                  constructionDict_rGT2_notAE,
                  constructionDict_rGT3,
                  constructionDict_rGT3_notAE,
                  constructionDict_trimm,
                  constructionDict_trimm_notAE,
                  constructionDict_trimm_rGT1,
                  constructionDict_trimm_rGT1_notAE,
                  constructionDict_trimm_rGT2,
                  constructionDict_trimm_rGT2_notAE,
                  constructionDict_trimm_rGT3,
                  constructionDict_trimm_rGT3_notAE)


# save results
outputFile = open(nameResultsPKL, "wb")
pkl.dump(allExperiments, outputFile)
outputFile.close()
...
# make scatter plot
plt.scatter(kernelDistancePMVals, scoreDistancePMVals)
...
# make scatter plot
plt.scatter(kernelDistanceMMVals, scoreDistanceMMVals)

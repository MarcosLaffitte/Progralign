...
constructionDict_notAE = dict()   # no ambiguous-edges check
...
def PGA(someType, someGT, someBaseDict, someDendro, someContained, someScore,
        holdV = True, holdE = True, holdAmbEdges = False, algorithm = "expand"):
    # local variables
    counter = 0
    heightGT = 0
    finalTime = 0
...
# WORK
theCustomDistances = [[3, 2, 1], [2, 3, 2], [1, 2, 3]]
kernelMatrixSSP = np.array(theCustomDistances)
constructionDict["SimilarityMatrix"] = deepcopy(kernelMatrixSSP)
...
# task message
print("* Progressive graph alignment - With Ambiguous Edges")
...
# task message
print("\n")
print("* Progressive graph alignment - Without Ambiguous Edges")
# progressive graph alignment
alignmentResults = PGA(theType, guideTreeSSP, constructionDict_notAE, dendrogramSSP,
                       containedGraphsSSP, requestedScore,
                       holdV = respectVLabels, holdE = respectELabels,
                       holdAmbEdges = False,
                       algorithm = MCSalgorithm)
...
# task message
print("\n")
print("* Progressive graph alignment - Random Tree Experiment")
# progressive graph alignment
